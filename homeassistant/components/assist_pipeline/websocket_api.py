...
class WebsocketStageHandler:
    """Handler for websocket stages."""
    ...
    def handle_start_stage(
        ...
        """Handle the start stage of a Websocket pipeline."""
        audio_settings = None
        wake_word_settings = None
        handler_id = None
        unregister_handler = None
        ...
        return (audio_settings, wake_word_settings, handler_id, unregister_handler)
...
async def websocket_run(
    ...
    audio_settings, wake_word_settings, handler_id, unregister_handler = (
        WebsocketStageHandler.handle_start_stage(
            pipeline, start_stage, connection, msg, input_args
        )
    )
